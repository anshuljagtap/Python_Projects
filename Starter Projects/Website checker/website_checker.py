...
def check_website(website: str, user_agent):
    try:
        ...
        print(f"Could not traceback website: {website}")
 
def main():
    sites: list[str] = get_websites('/Users/anshuljagtap/Desktop/30python projects/Small Projects/Website checker/website.csv')
