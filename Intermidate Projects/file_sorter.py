...
def create_folder(path: str, extensions: str) -> str:

    folder_name: str = extensions[1:]
...
def main():
    user_input: str = input("Provide a file path to sort:")
    ...
    if os.path.exists(path=user_input):
        ...
        print('Error: invalid path provide a valid file path') 
